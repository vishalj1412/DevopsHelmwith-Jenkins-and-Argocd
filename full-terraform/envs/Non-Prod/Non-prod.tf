...
module "eks" {
  ...
  eks-ng-subnet                 = [module.vpc.Private-Subnet-1,module.vpc.Private-Subnet-2]
...
####WAF
 ...
 module "opensearch" {
  ...
  subnet_id_os = [module.vpc.Private-Subnet-2,module.vpc.Private-Subnet-1,"subnet-0a4316ca5c03c4977"]
  count = var.os["env"] == "dev" ? 1 : 0
